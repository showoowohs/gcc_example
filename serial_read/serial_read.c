	...
	void main(void)
		...
		/* Change /dev/ttyUSB0 to the one corresponding to your system */
        	...
        	fd = open("/dev/ttymxc1",O_RDWR | O_NOCTTY);	/* ttyUSB0 is the FT232 based USB2SERIAL Converter   */
		...
		SerialPortSettings.c_ispeed = 115200;
		SerialPortSettings.c_ospeed = 115200;
